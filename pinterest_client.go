...
func NewClient() *PinterestClient {
	...
	return &PinterestClient{
		...
		MainURL:     "https://julias-randomizer.osc-fr1.scalingo.io/",
		BaseURL:     "https://api.pinterest.com/v5",
		RedirectUri: "https://julias-randomizer.osc-fr1.scalingo.io//redirect/",
...
func (client *PinterestClient) GetAuthUri() string {
	return "https://www.pinterest.com/oauth/?&client_id=1537633" + client.AppID + "&redirect_uri=" + client.RedirectUri + "&response_type=code" + "&scope=" + client.Scopes
}
